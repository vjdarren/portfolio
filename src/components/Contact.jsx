        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              I'm open to collaborations, tech discussions, or project opportunities. 
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                  ...
                  I'd love to hear from you. I'm always interested in new opportunities and collaborations.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Orpington, UK</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="w-12 h-12 bg-gray-100 dark:bg-gray-800 hover:bg-primary-100 dark:hover:bg-primary-900 rounded-lg flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 hover:scale-110"
